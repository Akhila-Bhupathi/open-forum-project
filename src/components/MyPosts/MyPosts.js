...
const MyPosts = () => {
  ...
  const deletePost=(post_id)=>{
      console.log(post_id);
    axios.delete(`https://morning-temple-69567.herokuapp.com/posts/${post_id}`,  {
        headers: {
  ...
  const classes = useStyles();
    return (
        <div>
          ...
          {posts.map((post)=>( (post.user_id===user) ?(
            <div key={post.post_id}  className={classes.divc}>
             ...
             <CardActions>
               ...
               <Button disabled ><img className={classes.voteicon} src={uparrow} /> </Button>
               ...
               <Button size="small" onClick={(e)=>deletePost(post.post_id)} color="primary" >
                  Delete
               </Button>
             </CardActions>
           </Card>
